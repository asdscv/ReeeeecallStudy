      ...
      {showCreateForm && (
        <div className="px-4 py-3 border-b border-border bg-muted">
          ...
          <button
            ...
            disabled={creating}
            className="px-4 py-1.5 bg-brand text-white rounded-lg text-sm font-medium hover:bg-brand-hover transition disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
          >
            {creating
