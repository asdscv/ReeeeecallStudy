...
export function QuickStartBanner({ variant }: { variant: QuickStartVariant }) {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-brand/30 rounded-xl p-4 sm:p-5 mb-4 sm:mb-6">
      <h2 className="text-sm font-semibold text-blue-900 mb-2">{t('quickStart.title')}</h2>
      <div className="space-y-2 text-xs sm:text-sm text-brand">
        ...
        <p>2. {t('quickStart.step2')} <code className="bg-brand/15 px-1.5 py-0.5 rounded text-blue-900 font-mono text-xs">Authorization: Bearer rc_...</code> {t('quickStart.step2Suffix')}</p>
