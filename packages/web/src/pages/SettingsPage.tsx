          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-2.5 text-sm text-white bg-brand rounded-lg hover:bg-brand-hover disabled:opacity-50 transition cursor-pointer font-medium whitespace-nowrap"
              >
          ...
          <div className="pt-4 border-t border-border">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-4 py-2.5 text-sm text-white bg-brand rounded-lg hover:bg-brand-hover disabled:opacity-50 transition cursor-pointer font-medium"
              >
                        ...
                        <div className="px-3.5 pb-3.5 pt-0 space-y-3 border-t border-border">
                          ...
                          <div className="flex gap-2 pt-1">
                            <button
                              ...
                              className="flex-1 px-4 py-2 text-sm text-white bg-brand rounded-lg hover:bg-brand-hover disabled:opacity-50 transition cursor-pointer font-medium"
                            >
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    disabled={generating}
                    className="flex-1 sm:flex-none px-4 py-2.5 text-sm text-white bg-brand rounded-lg hover:bg-brand-hover disabled:opacity-50 transition cursor-pointer font-medium"
                  >
