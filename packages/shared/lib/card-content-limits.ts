...
/**
 * 카드 한 장의 모든 텍스트 필드 합계.
 *
 * 프로덕션 377,099장 중 2,000자를 넘는 카드는 **2장**입니다(최대 2,188자). 그 둘은 DB 제약을
 * NOT VALID 로 걸어 그대로 살려 뒀고, 앞으로 만들거나 고치는 카드만 이 한도를 지킵니다 —
 * 이미 있는 남의 카드를 우리가 못 쓰게 만드는 것은 한도가 할 일이 아닙니다.
 */
export const CARD_MAX_CHARS = 2000
