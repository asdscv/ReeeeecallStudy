...
const buttons: { rating: SrsRating; key: string; color: string }[] = [
  { rating: 'again', key: '1', color: 'bg-red-500 hover:bg-red-600' },
  { rating: 'hard', key: '2', color: 'bg-amber-500 hover:bg-amber-600' },
  { rating: 'good', key: '3', color: 'bg-blue-500 hover:bg-blue-600' },
  { rating: 'easy', key: '4', color: 'bg-green-500 hover:bg-green-600' },
]
